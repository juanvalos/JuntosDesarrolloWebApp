...
CREATE USER TODOUSER IDENTIFIED BY "Juanito123456" DEFAULT TABLESPACE data QUOTA UNLIMITED ON data;
...
CREATE TABLE TODOUSER.USER_CHILD (
...
CREATE TABLE TODOUSER.registro_crecimiento (
    id NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    weight NUMBER,
    height NUMBER,
    age  NUMBER,
